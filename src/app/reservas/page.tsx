  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-2xl mx-auto bg-white p-6 sm:p-8 md:p-12 rounded-xl shadow-xl">
          <p className="text-center text-gray-600 mb-8">
            ...
            <a href="tel:+5527999998888" className="text-primary hover:underline font-medium">(27) 99999-8888</a>.
          </p>
          ...
          <form action="#" method="POST" className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input type="tel" name="phone" id="phone" autoComplete="tel" required className="mt-1 block w-full px-4 py-2.5 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary-dark focus:border-primary-dark sm:text-sm" placeholder="(XX) XXXXX-XXXX"/>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                ...
                <input type="date" name="date" id="date" required min={today} className="mt-1 block w-full px-4 py-2.5 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary-dark focus:border-primary-dark sm:text-sm"/>
              </div>
              <div>
                ...
                <select id="time" name="time" required className="mt-1 block w-full px-4 py-2.5 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-primary-dark focus:border-primary-dark sm:text-sm">
              ...
              <div>
                ...
                <input type="number" name="guests" id="guests" required min="1" max="8" defaultValue="2" className="mt-1 block w-full px-4 py-2.5 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary-dark focus:border-primary-dark sm:text-sm"/>
              </div>
            </div>
            ...
            <div>
              ...
              <textarea id="observations" name="observations" rows={3} className="mt-1 block w-full px-4 py-2.5 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary-dark focus:border-primary-dark sm:text-sm" placeholder="Alguma preferência de mesa, alergia ou comemoração especial?"></textarea>
            </div>
